...
const readAccountTransfer = `-- name: ReadAccountTransfer :many
...
type ReadAccountTransferParams struct {
	FromAccountID int64 `json:"from_account_id"`
	Limit         int32 `json:"limit"`
	Offset        int32 `json:"offset"`
}

func (q *Queries) ReadAccountTransfer(ctx context.Context, arg ReadAccountTransferParams) ([]Transfer, error) {
	rows, err := q.db.QueryContext(ctx, readAccountTransfer, arg.FromAccountID, arg.Limit, arg.Offset)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
